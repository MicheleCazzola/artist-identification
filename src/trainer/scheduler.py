...
class CustomMultiStepLR(_LRScheduler):
    def __init__(self, optimizer, milestones, gammas, last_epoch=-1):
        ...
        Args:
            ...
            gammas (list): List of gamma values for each milestone. Must be the same length as milestones.
...
if __name__ == '__main__':
    ...
    scheduler = CustomMultiStepLR(optimizer, milestones=[2, 4], gammas=[0.1, 0.5])
